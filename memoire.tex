...
\hypersetup{
  ...
  pdfauthor={Elina Marveaux ENcadrante Université : Antonine Ribardière Maitre de stage : Hugues Pécout},
  hidelinks,
...
\author{Elina Marveaux ENcadrante Université : Antonine Ribardière
Maitre de stage : Hugues Pécout}
\date{12/05/2022}
...
\begin{longtable}[]{@{}ll@{}}
\toprule()
& \textbf{\#} More results \{\#sec-more-results\} \\
\midrule()
\endhead
& \\
& Some results that wouldn't fit into the main thesis \\
